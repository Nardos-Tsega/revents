    ...
    return (
        <div className="fixed w-full bg-gradient-to-r from-[#182A73] to-[#17A7AC] h-14 flex items-center">
            ...
            <div className="flex gap-4">
                <button className="border border-white text-white rounded px-3 py-1 flex items-center justify-center text-sm">Login</button>
                <button className="border border-white text-white rounded px-3 py-1 flex items-center justify-center text-sm">Register</button>
            </div>
            </div>
        </div>
    )
